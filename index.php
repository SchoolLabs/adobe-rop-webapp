...
<head>
    ...
    <meta property="og:image" content="http://dev.seanhelvey.com/school_adobe/assets/img/fb_shareimage_1120x500.jpg">
    <meta property="og:url" content="http://dev.seanhelvey.com/school_adobe/index.php?score=<?php echo $score; ?>">
    <!-- // END FACEBOOK META -->
    ...
    <meta name="twitter:image:src" content="http://dev.seanhelvey.com/school_adobe/assets/img/fb_shareimage_1120x500.jpg?1">
    <!-- // END TWITTER META -->
  <style>
  *  {
    ...
    <div class="container" id="main-container">
      ...
      <div class="row" id="img-text-row">
        <div class="col-xs-12" id="img-text-col">
          <img class="img center-block" id="real-or-fake" src="assets/img/realorfake.png">
        </div>
      </div>
